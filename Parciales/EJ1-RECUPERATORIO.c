...
void configTimer00(void) {
    ...
    //###########################
    match1.matchvalue = ciclo_trabajo;//TIEMPO QUE VARIO SEGUN EL CICLO DE TRABAJO
    match1.extMatchOutputType = TIM_NOTHING;
    match1.matchChannel = TIM_MATCH_1;
    match1.IntOnMatch = ENABLE;//HABILITO INTERRUPCION
